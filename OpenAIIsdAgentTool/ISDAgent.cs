...
namespace OpenAIIsdAgentTool;

// Local copy of ISDAgent (uppercase echo)
public class ISDAgent : AIAgent
{
    override public string Name => "ISD_Agent";
    override public string Description => "A simple in-memory ISD agent that echoes user messages in uppercase.";
    ...
    public override Task<AgentRunResponse> RunAsync(IEnumerable<ChatMessage> messages, AgentThread? thread = null, AgentRunOptions? options = null, CancellationToken cancellationToken = default)
    {
        ...
        var assistantMessage = new ChatMessage(ChatRole.Assistant, $"ISD Agent says: {userText.ToUpperInvariant()}");
